...
// A project's own name and card must not change these template fixtures.
const injectGrokPwaHead = (html, ctx = {}) =>
  injectGrokPwaHeadImpl(html, { cwd: EMPTY_ROOT, ...ctx });
const createHeadInjector = (ctx = {}) => createHeadInjectorImpl({ cwd: EMPTY_ROOT, ...ctx });
