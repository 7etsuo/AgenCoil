...
const skillDocs = {
  skip:
    ...
    "optional template skill is not included in this checkout",
};

test("SKILL.md and AGENTS.md name the marker path and bound this script uses", skillDocs, () => {
...
test("the sections that own the brand-task prohibition never affirm a wait", skillDocs, () => {
...
test("SKILL.md tells the pass to self-check with the flag this CLI accepts", skillDocs, () => {
